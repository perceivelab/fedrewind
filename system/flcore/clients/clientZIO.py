...
class clientZIO(Client):
    def __init__(self, args, id, train_samples, test_samples,is_strong, id_by_type=-1, **kwargs):
        super().__init__(args, id, train_samples, test_samples,is_strong, **kwargs)
    ...
    def train(self, client_device = None):
